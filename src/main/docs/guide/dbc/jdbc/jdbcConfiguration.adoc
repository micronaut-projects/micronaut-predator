...
*** `OCSID.MODULE` will get the value of the class name where annotation `@ConnClientInfoAttr` is added (usually Micronaut Data repository class)
*** `OCSID.ACTION` will get the value of the method name which is annotated with `@ConnClientInfoAttr` annotation
